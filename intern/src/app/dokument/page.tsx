  ...
  return (
    <Container>
      <div className="pt-8 pb-16 sm:pt-12">
        ...
        <ul className="mt-10 grid gap-x-6 gap-y-9 sm:mt-12 sm:grid-cols-2 lg:grid-cols-3">
          {MALER.map((m) => (
            <li key={m.slug}>
              <Link
              ...
              >
                {/*
                  Miniatyren beskjæres i toppen av arket. Et helt A4 i et
                  kort blir frimerkestort; den øverste tredjedelen er der
                  formen faktisk leses.
                */}
                ...
                <h2 className="mt-4 text-[1.25rem] tracking-[-0.015em] transition-colors group-hover:text-aksent-tekst motion-reduce:transition-none">
                  {m.navn}
                </h2>
